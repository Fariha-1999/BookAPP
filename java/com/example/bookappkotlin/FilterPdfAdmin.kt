...
class FilterPdfAdmin :Filter{
    ...
    override fun performFiltering(constraint: CharSequence?): FilterResults {
        ...
        //value to be searched shouid not be null and not empty
        if (constraint !=null && constraint.isNotEmpty()){
            ...
            for(i in filterList.indices){
                ...
                if(filterList[i].title.lowercase().contains(constraint)){
                    //searched value is similar to vlaue in list. add to filtered list
    ...
    override fun publishResults(constraint: CharSequence, results:  FilterResults) {
        ...
        adapterPdfAdmin.pdfArrayList =results.values as ArrayList<ModelPdf> /* = java.util.ArrayList<com.example.bookappkotlin.ModelPdf> */
