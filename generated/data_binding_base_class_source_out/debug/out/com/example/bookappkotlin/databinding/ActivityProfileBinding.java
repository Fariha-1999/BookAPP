...
public final class ActivityProfileBinding implements ViewBinding {
  ...
  private ActivityProfileBinding(@NonNull RelativeLayout rootView, @NonNull TextView accountTypeTv,
      ...
      @NonNull TextView favoritesLabelTv, @NonNull TextView memberDateTv, @NonNull TextView nameTv,
      @NonNull ImageButton profileEditBtn, @NonNull ShapeableImageView profileIv,
      @NonNull TextView toolbarTitleTv, @NonNull View view1) {
  ...
  public static ActivityProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProfileBinding((RelativeLayout) rootView, accountTypeTv, backBtn,
          detailsLl, emailTv, favoriteBookCountTv, favoriteRv, favoritesLabelTv, memberDateTv,
          nameTv, profileEditBtn, profileIv, toolbarTitleTv, view1);
    }
