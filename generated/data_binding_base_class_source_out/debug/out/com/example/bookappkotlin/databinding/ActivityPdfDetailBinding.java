...
package com.example.bookappkotlin.databinding;
...
public final class ActivityPdfDetailBinding implements ViewBinding {
  ...
  private ActivityPdfDetailBinding(@NonNull RelativeLayout rootView, @NonNull ImageButton backBtn,
      ...
      @NonNull TextView categoryTv, @NonNull TextView dateLabelTv, @NonNull TextView dateTv,
      ...
      @NonNull Button favouriteBtn, @NonNull TextView pagesLabelTv, @NonNull TextView pagesTv,
  ...
  public static ActivityPdfDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPdfDetailBinding((RelativeLayout) rootView, backBtn, bookOptionsLl,
          categoryLabelTv, categoryTv, dateLabelTv, dateTv, descriptionTv, downloadBookBtn,
          downloadsLabelTv, downloadsTv, favouriteBtn, pagesLabelTv, pagesTv, pdfRl, pdfView,
          progressBar, readBookBtn, sizeLabelTv, sizeTv, titleTv, toolbarRl, viewsLabelTv, viewsTv);
    }
